...
rem set _jdkbasedir=C:\Program Files\java
set _jdkbasedir=C:\apps\Java
set _jdkdir=
set _jdkver=
for /D %%f in (%_jdkbasedir%\jdk1.%_version%.*) do call :found "%%f"
if "%_jdkdir%"=="" goto notfound

set java_home=%_jdkbasedir%\%_jdkdir%
call :javapath
path %new_path%
goto :report
