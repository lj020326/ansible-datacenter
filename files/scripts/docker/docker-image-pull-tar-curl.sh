...
usage() {
	...
	echo "       $0 /tmp/dockerimage-alpine alpine:latest"
	echo "       $0 /tmp/dockerimage-nginx nginx/nginx-ingress:latest"
	echo "       $0 /tmp/dockerimage-hello-world-latest hello-world:latest"
	echo "       $0 /tmp/dockerimage-hello-world-old hello-world:latest@sha256:8be990ef2aeb16dbcb9271ddfe2610fa6658d13f6dfb8bc72074cc1ca36966a7"
	[ -z "$1" ] || exit "$1"
}
