...
curlCmd="curl -vkIsSL https://${ENDPOINT}/${CONTEXT_PATH}"
echo "${curlCmd}"
${curlCmd}
...
#echo "curl --capath ${CACERT_TRUST_DIR} --cacert ${CACERT} -vIsS https://${ENDPOINT}/${CONTEXT_PATH}"
#curl --capath ${CACERT_TRUST_DIR} --cacert ${CACERT} -vIsS https://${ENDPOINT}/${CONTEXT_PATH}

curlCmd="curl -vIsSL --capath ${CACERT_TRUST_DIR} --cacert ${CACERT} -vsSL https://${ENDPOINT}/${CONTEXT_PATH}"
echo "${curlCmd}"
${curlCmd}
