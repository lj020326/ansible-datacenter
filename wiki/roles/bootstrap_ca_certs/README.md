...
# {{ bootstrap_ca_certs__base_dir }}/example.com/cacsr.json             - CFSSL CA config for intermediate CA
# {{ bootstrap_ca_certs__base_dir }}/example.com/ca_key.pem              - Private key for intermediate CA
# {{ bootstrap_ca_certs__base_dir }}/example.com/ca.csr                  - CSR for intermediate CA
# {{ bootstrap_ca_certs__base_dir }}/example.com/ca.pem                  - Certificate for intermediate CA
# {{ bootstrap_ca_certs__base_dir }}/example.com/www-1.example.com.csr   - CSR for a service/host
# {{ bootstrap_ca_certs__base_dir }}/example.com/www-1.example.com-key.pem - Private key for a service/host
# {{ bootstrap_ca_certs__base_dir }}/example.com/www-1.example.com.pem   - Certificate for a service/host
