```markdown
---
title: ansible-netplan Role Documentation
original_path: roles/bootstrap_netplan/README.md
category: Ansible Roles
tags: [ansible, netplan, networking]
---
...
- [Example Playbook](#example-playbook)
  ...
  - [Custom or Advanced Netplan Configuration](#custom-or-advanced-netplan-configuration)
- [License](#license)
...
- [Ansible Roles](https://github.com/your-repo/ansible-roles)
```

Ensure you replace `[Your Name or Organization]` with the appropriate author information.