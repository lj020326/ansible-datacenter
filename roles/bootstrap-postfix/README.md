 ...
 * `postfix_enable_original_recipient`[optional]: Enable/Disable the X-Original-To message header ([see](http://www.postfix.org/postconf.5.html#enable_original_recipient))
