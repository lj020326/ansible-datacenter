...
This playbook requires [CFSSL](https://github.com/cloudflare/cfssl) PKI toolkit binaries installed. You can use [bootstrap_cfssl](https://github.com/lj020326/ansible-datacenter/blob/main/roles/bootstrap_cfssl) to install CFSSL locally on your machine. If you want to store the generated certificates and CA's locally or on a network share specify the role variables below in `host_vars/localhost` or in `group_vars/all` e.g.
...
# "/home/da_user" then "bootstrap_kubernetes_ca__ca_conf_directory" will have a value of
# "/home/da_user/k8s/certs".
bootstrap_kubernetes_ca__ca_conf_directory: "{{ '~/k8s/certs' | expanduser }}"

# Directory permissions for directory specified in "bootstrap_kubernetes_ca__ca_conf_directory"
...
bootstrap_kubernetes_ca__etcd_server_csr_names_c: "DE"
bootstrap_kubernetes_ca__etcd_server_csr_names_l: "The_Internet"
bootstrap_kubernetes_ca__etcd_server_csr_names_o: "Kubernetes"
bootstrap_kubernetes_ca__etcd_server_csr_names_ou: "BY"
bootstrap_kubernetes_ca__etcd_server_csr_names_st: "Bayern"
...
bootstrap_kubernetes_ca__etcd_peer_csr_names_c: "DE"
bootstrap_kubernetes_ca__etcd_peer_csr_names_l: "The_Internet"
bootstrap_kubernetes_ca__etcd_peer_csr_names_o: "Kubernetes"
bootstrap_kubernetes_ca__etcd_peer_csr_names_ou: "BY"
bootstrap_kubernetes_ca__etcd_peer_csr_names_st: "Bayern"
...
bootstrap_kubernetes_ca__etcd_client_csr_names_c: "DE"
bootstrap_kubernetes_ca__etcd_client_csr_names_l: "The_Internet"
bootstrap_kubernetes_ca__etcd_client_csr_names_o: "Kubernetes"
bootstrap_kubernetes_ca__etcd_client_csr_names_ou: "BY"
bootstrap_kubernetes_ca__etcd_client_csr_names_st: "Bayern"

# CSR parameter for Kubernetes API server certificate. Used to secure the
# Kubernetes API server communication.
#
# NOTE: It's important that the value of "bootstrap_kubernetes_ca__apiserver_csr_cn" and
...
bootstrap_kubernetes_ca__admin_csr_names_c: "DE"
bootstrap_kubernetes_ca__admin_csr_names_l: "The_Internet"
bootstrap_kubernetes_ca__admin_csr_names_o: "system:masters" # DO NOT CHANGE!
bootstrap_kubernetes_ca__admin_csr_names_ou: "BY"
bootstrap_kubernetes_ca__admin_csr_names_st: "Bayern"
...
bootstrap_kubernetes_ca__worker_csr_names_c: "DE"
bootstrap_kubernetes_ca__worker_csr_names_l: "The_Internet"
bootstrap_kubernetes_ca__worker_csr_names_o: "system:nodes" # DO NOT CHANGE!
bootstrap_kubernetes_ca__worker_csr_names_ou: "BY"
bootstrap_kubernetes_ca__worker_csr_names_st: "Bayern"
...
bootstrap_kubernetes_ca__kube_proxy_csr_names_c: "DE"
bootstrap_kubernetes_ca__kube_proxy_csr_names_l: "The_Internet"
bootstrap_kubernetes_ca__kube_proxy_csr_names_o: "system:node-proxier" # DO NOT CHANGE!
bootstrap_kubernetes_ca__kube_proxy_csr_names_ou: "BY"
bootstrap_kubernetes_ca__kube_proxy_csr_names_st: "Bayern"
...
bootstrap_kubernetes_ca__scheduler_csr_names_c: "DE"
bootstrap_kubernetes_ca__scheduler_csr_names_l: "The_Internet"
bootstrap_kubernetes_ca__scheduler_csr_names_o: "system:kube-scheduler" # DO NOT CHANGE!
bootstrap_kubernetes_ca__scheduler_csr_names_ou: "BY"
bootstrap_kubernetes_ca__scheduler_csr_names_st: "Bayern"
...
bootstrap_kubernetes_ca__controller_manager_csr_names_c: "DE"
bootstrap_kubernetes_ca__controller_manager_csr_names_l: "The_Internet"
bootstrap_kubernetes_ca__controller_manager_csr_names_o: "system:kube-controller-manager" # DO NOT CHANGE!
bootstrap_kubernetes_ca__controller_manager_csr_names_ou: "BY"
bootstrap_kubernetes_ca__controller_manager_csr_names_st: "Bayern"
...
bootstrap_kubernetes_ca__controller_manager_sa_csr_names_c: "DE"
bootstrap_kubernetes_ca__controller_manager_sa_csr_names_l: "The_Internet"
bootstrap_kubernetes_ca__controller_manager_sa_csr_names_o: "Kubernetes"
bootstrap_kubernetes_ca__controller_manager_sa_csr_names_ou: "BY"
bootstrap_kubernetes_ca__controller_manager_sa_csr_names_st: "Bayern"
...
bootstrap_kubernetes_ca__etcd_cert_hosts:
  - 127.0.0.1
  - localhost

# For "bootstrap_kubernetes_ca__apiserver_cert_hosts" the same is basically true as with
# `bootstrap_kubernetes_ca__etcd_cert_hosts` but we also include the Kubernetes service IP `10.32.0.1`
...
# is deployed.
bootstrap_kubernetes_ca__apiserver_cert_hosts:
  - localhost
  - 127.0.0.1
  - 10.32.0.1
  - kubernetes
...
#
# bootstrap_kubernetes_ca__etcd_additional_clients:
#   - k8s-apiserver-etcd
#   - traefik
#   - cilium
#
...
```yaml
- hosts: bootstrap_kubernetes_ca__ca
