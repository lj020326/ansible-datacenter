...
```yaml
- name: Only AMD + NVIDIA
  import_role:
    name: bootstrap_gpu_drivers
  vars:
    bootstrap_gpu_drivers__enable_amd: true
    bootstrap_gpu_drivers__enable_nvidia: true
    bootstrap_gpu_drivers__enable_intel: false
```
...
* Prefers runtime detection via lspci (handles hybrid machines like control02 perfectly).
* Allows easy overrides.
* Supports Debian/Ubuntu + RedHat families (expand RedHat paths as needed).
...
- [tasks/nvidia/install-container-toolkit.yml](../../roles/bootstrap_gpu_drivers/tasks/nvidia/install-container-toolkit.yml)
- [tasks/nvidia/install-redhat.yml](../../roles/bootstrap_gpu_drivers/tasks/nvidia/install-redhat.yml)
- [tasks/nvidia/install-ubuntu-cuda-repo.yml](../../roles/bootstrap_gpu_drivers/tasks/nvidia/install-ubuntu-cuda-repo.yml)
